...
//     A few minor changes.
//	Version 3
//		By arduino.cc user "Je7sen"
//     	November 2013
//     	Using Arduino 1.0.3, 1.5.4
//		Port to Arduino Library in C++
//
...
// in this code.
//
#ifndef _TIME_DS1302_H
#define _TIME_DS1302_H
...
public:
TimeDS1302(uint8_t sclk, uint8_t io, uint8_t ce);
void begin(void);
...
//Application Level Function Prototype//
void set_time(int sec,int min, int hour, int weekday, int date, int months, int years);
int getSecond(void);
int getMinute(void);
int getHour(void);
int getDate(void);
